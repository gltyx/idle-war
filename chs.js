...
var cnPrefix = {
    ...
    "Increases XP received by 0.1% per level (": "每级增加 0.1% 的 经验值 (",
    "Increases health for all ships by 0.1% per level (": "每级增加所有舰船的生命值 0.1% (",
    ...
    "Reduces damage taken for all ships by 0.1hp per level (": "每级降低所有舰船受到的伤害 0.1hp (",
...
var cnRegReplace = new Map([
    ...
    [/^Increases damage for the current ship by (.+)\% per level \((.+)\%\)$/, '每级增加当前飞船的伤害 $1\% \($2\%\)'],
