...
var cnItems = {
    ...
    "Reset": "重置",
    "Ships": "飞船",
    "Spend your points in global upgrades that will greatly improve your ship's performance": "将您的点数用于全局升级，这将大大提高您的飞船性能",
    ...
    "Reduce enemies HP": "减少敌人生命值",
    "Reduce the cost to level up ships": "降低升级飞船的成本",
    "Reduce the trigger interval of ship bonuses": "减少飞船奖励的触发间隔",
    "Requirements": "要求",
    "Reset upgrades": "重置升级",
    "Scholar": "学者",
    "Ship damage increase:": "飞船伤害增加：",
    "Ship HP increase:": "飞船生命值增加：",
    "Ship level up cost reduction:": "飞船升级成本降低：",
    ...
    "You can now spend the XP earned on leveling up your ships": "您现在可以将获得的 经验值 用于升级您的飞船",
    "Assets": "素材",
    ...
    "Equipment at maximum level": "装备已达到最高级",
    "Legendary": "传奇",
    "": "",
    "": "",
    "": "",
...
var cnPrefix = {
    ...
    "Sound effects: ": "音效：",
    "Reduces enemies HP by 0.05hp per level (": "每级减少敌人生命值 0.05 生命值 (",
    "Reached stage ": "到达关卡 ",
...
var cnRegReplace = new Map([
    ...
    [/^Increases health for the current ship by (.+)\% per level \((.+)\%\)$/, '每级将当前飞船的 生命值 提高 $1\% \($2\%\)'],
    [/^Increases attack speed for the current ship by (.+)\% per level \((.+)\%\)$/, '每级将当前飞船的攻击速度提高 $1\% \($2\%\)'],
    [/^Reduces damage reduction bonus for all ships by (.+)\% per level \((.+)\%\)$/, '每级减少所有飞船的伤害减免奖励 $1\% \($2\%\)'],
    [/^Reduces attack speed for all ships by (.+)\% per level \((.+)\%\)$/, '每级降低所有飞船的攻击速度 $1\% \($2\%\)'],
    [/^Reduces health for the current ship by (.+)\% per level \((.+)\%\)$/, '每级将当前飞船的生命值降低 $1\% \($2\%\)'],
    ...
    [/^Reduces damage taken for the current ship (.+)hp per level \((.+)hp\)$/, '每级减少当前飞船受到的伤害 $1生命值 \($2生命值\)'],
    [/^Reduces damage taken for all ships by (.+)hp per level \((.+)hp\)$/, '每级降低所有飞船 受到的伤害 $1生命值 \($2生命值\)'],
    [/^Reduces enemies HP by (.+)hp per level \((.+)hp\)$/, '每级降低敌人生命值 $1生命值 \($2生命值\)'],
